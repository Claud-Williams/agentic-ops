# Three-view decision log (example)

Fictional persona: **Jordan Vale**, operations lead at the fictional Northwind Logistics.
...
Two questions emerge once enough rows accrue:

- **Is the model accurate?** How often "what the model expected" matched what Jordan actually chose. A high match rate means the model predicts Jordan well.
- **Where is the bias?** How often the better call beat both the instinct and the outcome. The third row is the small example: a loss-averse instinct kept a report no one used. A pattern of those is exactly the blind spot worth surfacing back to Jordan.
